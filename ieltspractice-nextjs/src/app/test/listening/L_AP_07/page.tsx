...
const listeningQuestions = [
  {
    ...
    audioUrl: '/audio/academic-lecture-07.mp3',
    options: [
...
export default function ListeningTestPage() {
  ...
  const testConfig = getTestById('L_AP_07');
  ...
  return (
    <TestInterface
      testId="L_AP_07"
      testType="listening"
      title={testConfig?.title || 'Academic Listening Test 7'}
    ...
    >
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <h2 className="text-xl font-bold text-gray-800 mb-4">Academic Lecture 7</h2>
              ...
              <div className="text-center">
                ...
                <div className="bg-white rounded-lg border p-4">
                  <audio controls className="w-full">
                    <source src="/audio/academic-lecture-07.mp3" type="audio/mpeg" />
                    <source src="/audio/academic-lecture-07.ogg" type="audio/ogg" />
